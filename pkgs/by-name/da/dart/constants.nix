rec {
  ...
  forStdenv = stdenv: {
    buildConstants = forPlatform stdenv.buildPlatform;
    hostConstants = forPlatform stdenv.hostPlatform;
    targetConstants = forPlatform stdenv.targetPlatform;
  };
}
